  ...
  return (
    <main className={containerStyles.pageBg}>
      ...
      <section className={containerStyles.container + ' ' + containerStyles.section + ' fade-in-delay'}>
        ...
        <h3 className="slide-up" style={{ fontSize: '1.15rem', fontWeight: 700, color: 'var(--primary-blue)', marginBottom: 10 }}>Mission & Vision</h3>
        ...
        <h3 className="slide-up" style={{ fontSize: '1.15rem', fontWeight: 700, color: 'var(--primary-blue)', marginBottom: 10 }}>Our Values</h3>
        <ul style={{ fontSize: '1.05rem', color: '#333', lineHeight: 1.7, marginBottom: 24, paddingLeft: 20 }}>
        ...
        <h3 className="slide-up" style={{ fontSize: '1.15rem', fontWeight: 700, color: 'var(--primary-blue)', marginBottom: 10 }}>Accreditations & Memberships</h3>
        <TrustBadges />
        <h3 className="slide-up" style={{ fontSize: '1.15rem', fontWeight: 700, color: 'var(--primary-blue)', margin: '2.5rem 0 10px 0' }}>Our Clients</h3>
        <FeaturedClients />
        <h3 className="slide-up" style={{ fontSize: '1.15rem', fontWeight: 700, color: 'var(--primary-blue)', margin: '2.5rem 0 10px 0' }}>What Our Clients Say</h3>
        <Testimonials />
      </section>
    </main>
  );
