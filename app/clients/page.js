...
export default function ClientsPage() {
  return (
    <main style={{ background: '#f4f8fc', minHeight: '100vh' }}>
      <Navbar />
      <section style={{ maxWidth: 1200, margin: '0 auto', padding: '3rem 1rem 2rem 1rem', display: 'grid', gap: '2.5rem', borderRadius: 18, boxShadow: '0 4px 24px rgba(26,35,126,0.07)', background: '#fff', marginTop: '2rem', marginBottom: '2rem' }}>
        <h1 style={{ fontSize: '2.5rem', fontWeight: 900, color: 'var(--primary-blue)', marginBottom: 32, textAlign: 'center', letterSpacing: '-1px', lineHeight: 1.1 }}>Our Clients</h1>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '2.5rem' }}>
          {/* Louis Vuitton Card */}
          <div style={{ background: '#f8fafc', borderRadius: 16, boxShadow: '0 2px 16px #1a237e11', padding: '2.2rem 1.5rem', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
