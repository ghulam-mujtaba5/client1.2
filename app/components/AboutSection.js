  ...
  return (
    <section id="about" style={{
      ...
      <div style={{ flex: 1, minWidth: 260 }}>
        <h2 style={{ fontSize: '2.2rem', fontWeight: 800, marginBottom: '1.5rem', color: '#e63946' }}>About Us</h2>
        ...
        <div style={{ display: 'flex', gap: '1.5rem', alignItems: 'center', marginTop: 16 }}>
          <span style={{ background: '#e63946', color: '#fff', borderRadius: 8, padding: '0.5rem 1.2rem', fontWeight: 700, fontSize: '1rem', letterSpacing: '0.5px', boxShadow: '0 2px 8px #e6394622' }}>SIA Approved</span>
          <span style={{ background: '#ffb703', color: '#222', borderRadius: 8, padding: '0.5rem 1.2rem', fontWeight: 700, fontSize: '1rem', letterSpacing: '0.5px', boxShadow: '0 2px 8px #ffb70322' }}>ISO Certified</span>
        </div>
      </div>
      <div style={{ flex: 1, minWidth: 260, display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
        <img src="/globe.svg" alt="Accreditation badge" style={{ width: 120, height: 120, opacity: 0.18, filter: 'drop-shadow(0 2px 8px #e6394622)' }} />
      </div>
    </section>
  );
}
