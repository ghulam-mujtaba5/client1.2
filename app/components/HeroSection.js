...
export default function HeroSection() {
  return (
    <section style={{
      ...
      <svg width="120" height="120" viewBox="0 0 120 120" fill="none" style={{ position: 'absolute', right: 40, top: 40, opacity: 0.12, zIndex: 2 }}><circle cx="60" cy="60" r="58" stroke="var(--white)" strokeWidth="4" /><rect x="35" y="35" width="50" height="50" rx="12" fill="var(--primary-blue)" opacity="0.2" /></svg>
