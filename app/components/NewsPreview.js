...
export default function NewsPreview() {
  return (
    <section style={{width: '100%', background: 'var(--white)', padding: '3rem 0', borderTop: '1px solid #eee'}}>
      <h2 style={{textAlign: 'center', color: 'var(--primary-blue)', fontWeight: 800, fontSize: '2rem', marginBottom: 32}}>Latest News & Insights</h2>
