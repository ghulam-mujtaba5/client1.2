...
export default function Testimonials() {
  return (
    <section className="fade-in" style={{width: '100%', background: 'var(--white)', padding: '3rem 0', borderTop: '1px solid #eee', borderBottom: '1px solid #eee'}}>
      <h2 className="slide-up" style={{textAlign: 'center', color: 'var(--primary-blue)', fontWeight: 800, fontSize: '2rem', marginBottom: 32}}>What Our Clients Say</h2>
...
function TestimonialCard({ name, text }) {
  return (
    <div className="scale-in" style={{background: 'var(--accent-blue-light)', borderRadius: 12, boxShadow: '0 2px 12px #1a237e11', padding: '2rem', maxWidth: 340, minWidth: 220, fontSize: '1.05rem', color: 'var(--gray-dark)'}}>
