...
export default function GuardDogSecurityPage() {
  ...
  return (
    <main className="fade-in animate-on-scroll" style={{padding: '3.5rem 0', maxWidth: 900, margin: '0 auto', background: '#fff', borderRadius: 18, boxShadow: '0 4px 32px #1a237e13'}} aria-label="Guard Dog Security main content" tabIndex={0}>
      ...
      >Guard Dog Security</h1>
      <span className="visually-hidden" id="guarddog-desc">Highly trained security dogs and handlers for maximum deterrence and rapid response. Ideal for large sites, vacant properties, and high-risk environments.</span>
      <section className="fade-in-delay animate-on-scroll" aria-describedby="guarddog-desc" style={{display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: 32}}>
        <img ref={imgRef} src="/shield.svg" alt="Guard Dog Security" className="fade-in animate-on-scroll" style={{height: 90, marginBottom: 18, opacity: 0.8, transition: 'transform 0.4s'}}
          tabIndex={0}
      ...
      <section aria-label="Guard Dog Security features" style={{marginBottom: 32}}>
        ...
        <ul className="slide-up animate-on-scroll fade-in-delay" style={{fontSize: '1.12rem', color: '#222', paddingLeft: 24, lineHeight: 1.8, fontWeight: 500, margin: 0, listStyle: 'disc inside', textAlign: 'left', maxWidth: 700, marginLeft: 'auto', marginRight: 'auto'}}>
          <li tabIndex={0} style={{transition: 'color 0.2s'}} onMouseOver={e => e.currentTarget.style.color = '#1976d2'} onMouseOut={e => e.currentTarget.style.color = '#222'} onFocus={e => e.currentTarget.style.color = '#1976d2'} onBlur={e => e.currentTarget.style.color = '#222'}>Professional dog handlers</li>
          <li tabIndex={0} style={{transition: 'color 0.2s'}} onMouseOver={e => e.currentTarget.style.color = '#1976d2'} onMouseOut={e => e.currentTarget.style.color = '#222'} onFocus={e => e.currentTarget.style.color = '#1976d2'} onBlur={e => e.currentTarget.style.color = '#222'}>Visible deterrent for intruders</li>
          ...
          <li tabIndex={0} style={{transition: 'color 0.2s'}} onMouseOver={e => e.currentTarget.style.color = '#1976d2'} onMouseOut={e => e.currentTarget.style.color = '#222'} onFocus={e => e.currentTarget.style.color = '#1976d2'} onBlur={e => e.currentTarget.style.color = '#222'}>Suitable for sites, events, and vacant premises</li>
        </ul>
      </section>
      <div style={{display: 'flex', justifyContent: 'center'}}>
        <a ref={ctaRef} className="scale-in interactive-cta fade-in-delay" href="/contact" style={{position: 'relative', overflow: 'hidden', background: 'linear-gradient(90deg, var(--primary-blue) 60%, var(--accent-blue) 100%)', color: 'var(--white)', padding: '1rem 2.5rem', borderRadius: 8, fontWeight: 800, textDecoration: 'none', fontSize: '1.18rem', boxShadow: '0 2px 12px #2196f322', letterSpacing: '0.5px', transition: 'background 0.2s, box-shadow 0.2s'}}
          aria-label="Request a guard dog security quote"
          tabIndex={0}
