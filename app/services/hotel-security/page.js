...
export default function HotelSecurityPage() {
  ...
  return (
    <main className="fade-in animate-on-scroll" style={{padding: '3.5rem 0', maxWidth: 900, margin: '0 auto', background: '#fff', borderRadius: 18, boxShadow: '0 4px 32px #1a237e13'}} aria-label="Hotel Security main content" tabIndex={0}>
      ...
      >Hotel Security</h1>
      <span className="visually-hidden" id="hotel-desc">Discreet, multi-skilled security and concierge staff for hotels and hospitality venues. We ensure guest safety, asset protection, and a welcoming environment.</span>
      <section className="fade-in-delay animate-on-scroll" aria-describedby="hotel-desc" style={{display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: 32}}>
        <img ref={imgRef} src="/star.svg" alt="Hotel Security" style={{height: 90, marginBottom: 18, opacity: 0.8, transition: 'transform 0.4s'}}
          tabIndex={0}
      ...
      <section aria-label="Hotel Security features" style={{marginBottom: 32}}>
        ...
        <ul className="slide-up animate-on-scroll" style={{fontSize: '1.12rem', color: '#222', paddingLeft: 24, lineHeight: 1.8, fontWeight: 500, margin: 0, listStyle: 'disc inside', textAlign: 'left', maxWidth: 700, marginLeft: 'auto', marginRight: 'auto'}}>
          ...
          <li tabIndex={0} style={{transition: 'color 0.2s'}} onMouseOver={e => e.currentTarget.style.color = '#1976d2'} onMouseOut={e => e.currentTarget.style.color = '#222'} onFocus={e => e.currentTarget.style.color = '#1976d2'} onBlur={e => e.currentTarget.style.color = '#222'}>Customer service focused approach</li>
        </ul>
      </section>
