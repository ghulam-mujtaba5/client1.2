...
export default function VacantPremisesSecurityPage() {
  ...
  return (
    <main className="fade-in animate-on-scroll" style={{padding: '3.5rem 0', maxWidth: 900, margin: '0 auto', background: '#fff', borderRadius: 18, boxShadow: '0 4px 32px #1a237e13'}} aria-label="Vacant Premises Security main content" tabIndex={0}>
      ...
      >Vacant Premises Security</h1>
      <span className="visually-hidden" id="vacant-desc">Protection for empty properties against trespass, vandalism, and theft. Regular patrols, alarm response, and physical security upgrades for vacant sites.</span>
      <section className="fade-in-delay animate-on-scroll" aria-describedby="vacant-desc" style={{display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: 32}}>
        <img ref={imgRef} src="/window.svg" alt="Vacant Premises Security" className="fade-in animate-on-scroll" style={{height: 90, marginBottom: 18, opacity: 0.8, transition: 'transform 0.4s'}}
          tabIndex={0}
      ...
      <section aria-label="Vacant Premises Security features" style={{marginBottom: 32}}>
        ...
        <ul className="slide-up animate-on-scroll fade-in-delay" style={{fontSize: '1.12rem', color: '#222', paddingLeft: 24, lineHeight: 1.8, fontWeight: 500, margin: 0, listStyle: 'disc inside', textAlign: 'left', maxWidth: 700, marginLeft: 'auto', marginRight: 'auto'}}>
          <li tabIndex={0} style={{transition: 'color 0.2s'}} onMouseOver={e => e.currentTarget.style.color = '#1976d2'} onMouseOut={e => e.currentTarget.style.color = '#222'} onFocus={e => e.currentTarget.style.color = '#1976d2'} onBlur={e => e.currentTarget.style.color = '#222'}>Regular site patrols</li>
          <li tabIndex={0} style={{transition: 'color 0.2s'}} onMouseOver={e => e.currentTarget.style.color = '#1976d2'} onMouseOut={e => e.currentTarget.style.color = '#222'} onFocus={e => e.currentTarget.style.color = '#1976d2'} onBlur={e => e.currentTarget.style.color = '#222'}>Alarm response and incident management</li>
          ...
          <li tabIndex={0} style={{transition: 'color 0.2s'}} onMouseOver={e => e.currentTarget.style.color = '#1976d2'} onMouseOut={e => e.currentTarget.style.color = '#222'} onFocus={e => e.currentTarget.style.color = '#1976d2'} onBlur={e => e.currentTarget.style.color = '#222'}>Detailed reporting and documentation</li>
        </ul>
      </section>
      <div style={{display: 'flex', justifyContent: 'center'}}>
        <a ref={ctaRef} className="scale-in interactive-cta fade-in-delay" href="/contact" style={{position: 'relative', overflow: 'hidden', background: 'linear-gradient(90deg, var(--primary-blue) 60%, var(--accent-blue) 100%)', color: 'var(--white)', padding: '1rem 2.5rem', borderRadius: 8, fontWeight: 800, textDecoration: 'none', fontSize: '1.18rem', boxShadow: '0 2px 12px #2196f322', letterSpacing: '0.5px', transition: 'background 0.2s, box-shadow 0.2s'}}
          aria-label="Request a vacant premises security quote"
          tabIndex={0}
